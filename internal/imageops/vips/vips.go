...
// vipsgenOklab2Oklch vips_Oklab2Oklch transform Oklab to Oklch
func vipsgenOklab2Oklch(in *C.VipsImage) (*C.VipsImage, error) {
	var out *C.VipsImage
	if err := C.vipsgen_Oklab2Oklch(in, &out); err != 0 {
		return nil, handleImageError(out)
	}
	return out, nil
}

// vipsgenOklab2XYZ vips_Oklab2XYZ transform Oklab to XYZ
func vipsgenOklab2XYZ(in *C.VipsImage) (*C.VipsImage, error) {
	var out *C.VipsImage
	if err := C.vipsgen_Oklab2XYZ(in, &out); err != 0 {
		return nil, handleImageError(out)
	}
	return out, nil
}

// vipsgenOklch2Oklab vips_Oklch2Oklab transform Oklch to Oklab
func vipsgenOklch2Oklab(in *C.VipsImage) (*C.VipsImage, error) {
	var out *C.VipsImage
	if err := C.vipsgen_Oklch2Oklab(in, &out); err != 0 {
		return nil, handleImageError(out)
	}
	return out, nil
}
...
// vipsgenXYZ2Oklab vips_XYZ2Oklab transform XYZ to Oklab
func vipsgenXYZ2Oklab(in *C.VipsImage) (*C.VipsImage, error) {
	var out *C.VipsImage
	if err := C.vipsgen_XYZ2Oklab(in, &out); err != 0 {
		return nil, handleImageError(out)
	}
	return out, nil
}
...
func vipsgenHeifsaveWithOptions(in *C.VipsImage, filename string, q int, bitdepth int, lossless bool, compression HeifCompression, effort int, subsampleMode Subsample, encoder HeifEncoder, tune string, keep Keep, background []float64, pageHeight int, profile string) (error) {
	cfilename := C.CString(filename)
	defer freeCString(cfilename)
	cbackground, cbackgroundLength, err := convertToDoubleArray(background)
	if err != nil {
	...
	defer freeCString(ctune)
	cprofile := C.CString(profile)
	defer freeCString(cprofile)
	if err := C.vipsgen_heifsave_with_options(in, cfilename, C.gint(q), C.gint(bitdepth), C.int(boolToInt(lossless)), C.VipsForeignHeifCompression(compression), C.gint(effort), C.VipsForeignSubsample(subsampleMode), C.VipsForeignHeifEncoder(encoder), ctune, C.VipsForeignKeep(keep), cbackground, cbackgroundLength, C.gint(pageHeight), cprofile); err != 0 {
		return handleVipsError()
	}
	return nil
}
...
func vipsgenHeifsaveBufferWithOptions(in *C.VipsImage, q int, bitdepth int, lossless bool, compression HeifCompression, effort int, subsampleMode Subsample, encoder HeifEncoder, tune string, keep Keep, background []float64, pageHeight int, profile string) ([]byte, error) {
	var buf unsafe.Pointer
	var length C.size_t
	cbackground, cbackgroundLength, err := convertToDoubleArray(background)
	if err != nil {
...
func vipsgenHeifsaveTargetWithOptions(in *C.VipsImage, target *C.VipsTargetCustom, q int, bitdepth int, lossless bool, compression HeifCompression, effort int, subsampleMode Subsample, encoder HeifEncoder, tune string, keep Keep, background []float64, pageHeight int, profile string) (error) {
	cbackground, cbackgroundLength, err := convertToDoubleArray(background)
	if err != nil {
		return err
	}
...
// vipsgenJpegsave vips_jpegsave save as jpeg
...
// vipsgenJpegsaveWithOptions vips_jpegsave save as jpeg with optional arguments
...
// vipsgenJpegsaveBuffer vips_jpegsave_buffer save as jpeg
...
// vipsgenJpegsaveBufferWithOptions vips_jpegsave_buffer save as jpeg with optional arguments
...
// vipsgenJpegsaveTarget vips_jpegsave_target save as jpeg
...
// vipsgenJpegsaveTargetWithOptions vips_jpegsave_target save as jpeg with optional arguments
...
func vipsgenJxlsaveWithOptions(in *C.VipsImage, filename string, tier int, distance float64, effort int, lossless bool, q int, bitdepth int, keep Keep, background []float64, pageHeight int, profile string) (error) {
	cfilename := C.CString(filename)
	defer freeCString(cfilename)
	cbackground, cbackgroundLength, err := convertToDoubleArray(background)
	if err != nil {
	...
	cprofile := C.CString(profile)
	defer freeCString(cprofile)
	if err := C.vipsgen_jxlsave_with_options(in, cfilename, C.gint(tier), C.double(distance), C.gint(effort), C.int(boolToInt(lossless)), C.gint(q), C.gint(bitdepth), C.VipsForeignKeep(keep), cbackground, cbackgroundLength, C.gint(pageHeight), cprofile); err != 0 {
		return handleVipsError()
	}
	return nil
}
...
func vipsgenJxlsaveBufferWithOptions(in *C.VipsImage, tier int, distance float64, effort int, lossless bool, q int, bitdepth int, keep Keep, background []float64, pageHeight int, profile string) ([]byte, error) {
	var buf unsafe.Pointer
	var length C.size_t
	cbackground, cbackgroundLength, err := convertToDoubleArray(background)
	if err != nil {
	...
	cprofile := C.CString(profile)
	defer freeCString(cprofile)
	if err := C.vipsgen_jxlsave_buffer_with_options(in, &buf, &length, C.gint(tier), C.double(distance), C.gint(effort), C.int(boolToInt(lossless)), C.gint(q), C.gint(bitdepth), C.VipsForeignKeep(keep), cbackground, cbackgroundLength, C.gint(pageHeight), cprofile); err != 0 {
		return nil, handleVipsError()
	}
	return bufferToBytes(buf, length), nil
}
...
func vipsgenJxlsaveTargetWithOptions(in *C.VipsImage, target *C.VipsTargetCustom, tier int, distance float64, effort int, lossless bool, q int, bitdepth int, keep Keep, background []float64, pageHeight int, profile string) (error) {
	cbackground, cbackgroundLength, err := convertToDoubleArray(background)
	if err != nil {
		return err
	}
	...
	cprofile := C.CString(profile)
	defer freeCString(cprofile)
	if err := C.vipsgen_jxlsave_target_with_options(in, target, C.gint(tier), C.double(distance), C.gint(effort), C.int(boolToInt(lossless)), C.gint(q), C.gint(bitdepth), C.VipsForeignKeep(keep), cbackground, cbackgroundLength, C.gint(pageHeight), cprofile); err != 0 {
		return handleVipsError()
	}
	return nil
}
...
func vipsgenMagickloadSourceWithOptions(source *C.VipsSourceCustom, density string, page int, n int, memory bool, access Access, failOn FailOn, revalidate bool) (*C.VipsImage, error) {
	...
	cdensity := C.CString(density)
	defer freeCString(cdensity)
	if err := C.vipsgen_magickload_source_with_options(source, &out, cdensity, C.gint(page), C.gint(n), C.int(boolToInt(memory)), C.VipsAccess(access), C.VipsFailOn(failOn), C.int(boolToInt(revalidate))); err != 0 {
		return nil, handleImageError(out)
	}
	return out, nil
}
...
// vipsgenPdfload vips_pdfload load PDF from file (poppler)
...
// vipsgenPdfloadWithOptions vips_pdfload load PDF from file (poppler) with optional arguments
func vipsgenPdfloadWithOptions(filename string, page int, n int, dpi float64, scale float64, background []float64, password string, pageBox PdfPageBox, memory bool, access Access, failOn FailOn, revalidate bool) (*C.VipsImage, error) {
	var out *C.VipsImage
	cfilename := C.CString(filename)
	defer freeCString(cfilename)
	cbackground, cbackgroundLength, err := convertToDoubleArray(background)
	...
	if err := C.vipsgen_pdfload_with_options(cfilename, &out, C.gint(page), C.gint(n), C.double(dpi), C.double(scale), cbackground, cbackgroundLength, cpassword, C.VipsForeignPdfPageBox(pageBox), C.int(boolToInt(memory)), C.VipsAccess(access), C.VipsFailOn(failOn), C.int(boolToInt(revalidate))); err != 0 {
		return nil, handleImageError(out)
	}
	return out, nil
}

// vipsgenPdfloadBuffer vips_pdfload_buffer load PDF from buffer (poppler)
...
// vipsgenPdfloadBufferWithOptions vips_pdfload_buffer load PDF from buffer (poppler) with optional arguments
func vipsgenPdfloadBufferWithOptions(buf []byte, page int, n int, dpi float64, scale float64, background []float64, password string, pageBox PdfPageBox, memory bool, access Access, failOn FailOn, revalidate bool) (*C.VipsImage, error) {
	src := buf
	// Reference src here so it's not garbage collected during image initialization.
	defer runtime.KeepAlive(src)
	var out *C.VipsImage
	...
	cpassword := C.CString(password)
	defer freeCString(cpassword)
	if err := C.vipsgen_pdfload_buffer_with_options(unsafe.Pointer(&src[0]), C.size_t(len(src)), &out, C.gint(page), C.gint(n), C.double(dpi), C.double(scale), cbackground, cbackgroundLength, cpassword, C.VipsForeignPdfPageBox(pageBox), C.int(boolToInt(memory)), C.VipsAccess(access), C.VipsFailOn(failOn), C.int(boolToInt(revalidate))); err != 0 {
		return nil, handleImageError(out)
	}
	return out, nil
}

// vipsgenPdfloadSource vips_pdfload_source load PDF from source (poppler)
...
// vipsgenPdfloadSourceWithOptions vips_pdfload_source load PDF from source (poppler) with optional arguments
func vipsgenPdfloadSourceWithOptions(source *C.VipsSourceCustom, page int, n int, dpi float64, scale float64, background []float64, password string, pageBox PdfPageBox, memory bool, access Access, failOn FailOn, revalidate bool) (*C.VipsImage, error) {
	var out *C.VipsImage
	cbackground, cbackgroundLength, err := convertToDoubleArray(background)
	if err != nil {
		return nil, err
	...
	cpassword := C.CString(password)
	defer freeCString(cpassword)
	if err := C.vipsgen_pdfload_source_with_options(source, &out, C.gint(page), C.gint(n), C.double(dpi), C.double(scale), cbackground, cbackgroundLength, cpassword, C.VipsForeignPdfPageBox(pageBox), C.int(boolToInt(memory)), C.VipsAccess(access), C.VipsFailOn(failOn), C.int(boolToInt(revalidate))); err != 0 {
		return nil, handleImageError(out)
	}
	return out, nil
}
...
// vipsgenPngsave vips_pngsave save image to file as png
...
// vipsgenPngsaveWithOptions vips_pngsave save image to file as png with optional arguments
...
// vipsgenPngsaveBuffer vips_pngsave_buffer save image to buffer as png
...
// vipsgenPngsaveBufferWithOptions vips_pngsave_buffer save image to buffer as png with optional arguments
...
func vipsgenSystemWithOptions(cmdFormat string, in []*C.VipsImage, inFormat string, outFormat string, cache bool) (*C.VipsImage, error) {
	var out *C.VipsImage
	ccmdFormat := C.CString(cmdFormat)
	defer freeCString(ccmdFormat)
	...
	if err := C.vipsgen_system_with_options(ccmdFormat, cin, cinLength, cinFormat, coutFormat, C.int(boolToInt(cache))); err != 0 {
		return nil, handleImageError(out)
	}
	return out, nil
}
...
// vipsgenUhdr2scRGB vips_uhdr2scRGB transform uhdr to scRGB
func vipsgenUhdr2scRGB(in *C.VipsImage) (*C.VipsImage, error) {
	var out *C.VipsImage
	if err := C.vipsgen_uhdr2scRGB(in, &out); err != 0 {
		return nil, handleImageError(out)
	}
	return out, nil
}

// vipsgenUhdrload vips_uhdrload load a UHDR image
func vipsgenUhdrload(filename string) (*C.VipsImage, error) {
	var out *C.VipsImage
	cfilename := C.CString(filename)
	defer freeCString(cfilename)
	if err := C.vipsgen_uhdrload(cfilename, &out); err != 0 {
		return nil, handleImageError(out)
	}
	return out, nil
}

// vipsgenUhdrloadWithOptions vips_uhdrload load a UHDR image with optional arguments
func vipsgenUhdrloadWithOptions(filename string, shrink int, memory bool, access Access, failOn FailOn, revalidate bool) (*C.VipsImage, error) {
	var out *C.VipsImage
	cfilename := C.CString(filename)
	defer freeCString(cfilename)
	if err := C.vipsgen_uhdrload_with_options(cfilename, &out, C.gint(shrink), C.int(boolToInt(memory)), C.VipsAccess(access), C.VipsFailOn(failOn), C.int(boolToInt(revalidate))); err != 0 {
		return nil, handleImageError(out)
	}
	return out, nil
}

// vipsgenUhdrloadBuffer vips_uhdrload_buffer load a UHDR image
func vipsgenUhdrloadBuffer(buf []byte) (*C.VipsImage, error) {
	src := buf
	// Reference src here so it's not garbage collected during image initialization.
	defer runtime.KeepAlive(src)
	var out *C.VipsImage
	if err := C.vipsgen_uhdrload_buffer(unsafe.Pointer(&src[0]), C.size_t(len(src)), &out); err != 0 {
		return nil, handleImageError(out)
	}
	return out, nil
}

// vipsgenUhdrloadBufferWithOptions vips_uhdrload_buffer load a UHDR image with optional arguments
func vipsgenUhdrloadBufferWithOptions(buf []byte, shrink int, memory bool, access Access, failOn FailOn, revalidate bool) (*C.VipsImage, error) {
	src := buf
	// Reference src here so it's not garbage collected during image initialization.
	defer runtime.KeepAlive(src)
	var out *C.VipsImage
	if err := C.vipsgen_uhdrload_buffer_with_options(unsafe.Pointer(&src[0]), C.size_t(len(src)), &out, C.gint(shrink), C.int(boolToInt(memory)), C.VipsAccess(access), C.VipsFailOn(failOn), C.int(boolToInt(revalidate))); err != 0 {
		return nil, handleImageError(out)
	}
	return out, nil
}

// vipsgenUhdrloadSource vips_uhdrload_source load a UHDR image
func vipsgenUhdrloadSource(source *C.VipsSourceCustom) (*C.VipsImage, error) {
	var out *C.VipsImage
	if err := C.vipsgen_uhdrload_source(source, &out); err != 0 {
		return nil, handleImageError(out)
	}
	return out, nil
}

// vipsgenUhdrloadSourceWithOptions vips_uhdrload_source load a UHDR image with optional arguments
func vipsgenUhdrloadSourceWithOptions(source *C.VipsSourceCustom, shrink int, memory bool, access Access, failOn FailOn, revalidate bool) (*C.VipsImage, error) {
	var out *C.VipsImage
	if err := C.vipsgen_uhdrload_source_with_options(source, &out, C.gint(shrink), C.int(boolToInt(memory)), C.VipsAccess(access), C.VipsFailOn(failOn), C.int(boolToInt(revalidate))); err != 0 {
		return nil, handleImageError(out)
	}
	return out, nil
}

// vipsgenUhdrsave vips_uhdrsave save image in UltraHDR format
func vipsgenUhdrsave(in *C.VipsImage, filename string) (error) {
	cfilename := C.CString(filename)
	defer freeCString(cfilename)
	if err := C.vipsgen_uhdrsave(in, cfilename); err != 0 {
		return handleVipsError()
	}
	return nil
}

// vipsgenUhdrsaveWithOptions vips_uhdrsave save image in UltraHDR format with optional arguments
func vipsgenUhdrsaveWithOptions(in *C.VipsImage, filename string, q int, keep Keep, background []float64, pageHeight int, profile string) (error) {
	cfilename := C.CString(filename)
	defer freeCString(cfilename)
	cbackground, cbackgroundLength, err := convertToDoubleArray(background)
	if err != nil {
	...
	cprofile := C.CString(profile)
	defer freeCString(cprofile)
	if err := C.vipsgen_uhdrsave_with_options(in, cfilename, C.gint(q), C.VipsForeignKeep(keep), cbackground, cbackgroundLength, C.gint(pageHeight), cprofile); err != 0 {
		return handleVipsError()
	}
	return nil
}

// vipsgenUhdrsaveBuffer vips_uhdrsave_buffer save image in UltraHDR format
func vipsgenUhdrsaveBuffer(in *C.VipsImage) ([]byte, error) {
	var buf unsafe.Pointer
	var length C.size_t
	if err := C.vipsgen_uhdrsave_buffer(in, &buf, &length); err != 0 {
		return nil, handleVipsError()
	}
	return bufferToBytes(buf, length), nil
}

// vipsgenUhdrsaveBufferWithOptions vips_uhdrsave_buffer save image in UltraHDR format with optional arguments
func vipsgenUhdrsaveBufferWithOptions(in *C.VipsImage, q int, keep Keep, background []float64, pageHeight int, profile string) ([]byte, error) {
	var buf unsafe.Pointer
	var length C.size_t
	cbackground, cbackgroundLength, err := convertToDoubleArray(background)
	if err != nil {
	...
	cprofile := C.CString(profile)
	defer freeCString(cprofile)
	if err := C.vipsgen_uhdrsave_buffer_with_options(in, &buf, &length, C.gint(q), C.VipsForeignKeep(keep), cbackground, cbackgroundLength, C.gint(pageHeight), cprofile); err != 0 {
		return nil, handleVipsError()
	}
	return bufferToBytes(buf, length), nil
}

// vipsgenUhdrsaveTarget vips_uhdrsave_target save image in UltraHDR format
func vipsgenUhdrsaveTarget(in *C.VipsImage, target *C.VipsTargetCustom) (error) {
	
	if err := C.vipsgen_uhdrsave_target(in, target); err != 0 {
		return handleVipsError()
	}
	return nil
}

// vipsgenUhdrsaveTargetWithOptions vips_uhdrsave_target save image in UltraHDR format with optional arguments
func vipsgenUhdrsaveTargetWithOptions(in *C.VipsImage, target *C.VipsTargetCustom, q int, keep Keep, background []float64, pageHeight int, profile string) (error) {
	cbackground, cbackgroundLength, err := convertToDoubleArray(background)
	if err != nil {
		return err
	}
	...
	cprofile := C.CString(profile)
	defer freeCString(cprofile)
	if err := C.vipsgen_uhdrsave_target_with_options(in, target, C.gint(q), C.VipsForeignKeep(keep), cbackground, cbackgroundLength, C.gint(pageHeight), cprofile); err != 0 {
		return handleVipsError()
	}
	return nil
}
...
func vipsgenWebpsaveWithOptions(in *C.VipsImage, filename string, q int, lossless bool, exact bool, preset WebpPreset, smartSubsample bool, nearLossless bool, alphaQ int, minSize bool, kmin int, kmax int, effort int, targetSize int, mixed bool, smartDeblock bool, passes int, keep Keep, background []float64, pageHeight int, profile string) (error) {
	cfilename := C.CString(filename)
	defer freeCString(cfilename)
	cbackground, cbackgroundLength, err := convertToDoubleArray(background)
	if err != nil {
	...
	cprofile := C.CString(profile)
	defer freeCString(cprofile)
	if err := C.vipsgen_webpsave_with_options(in, cfilename, C.gint(q), C.int(boolToInt(lossless)), C.int(boolToInt(exact)), C.VipsForeignWebpPreset(preset), C.int(boolToInt(smartSubsample)), C.int(boolToInt(nearLossless)), C.gint(alphaQ), C.int(boolToInt(minSize)), C.gint(kmin), C.gint(kmax), C.gint(effort), C.gint(targetSize), C.int(boolToInt(mixed)), C.int(boolToInt(smartDeblock)), C.gint(passes), C.VipsForeignKeep(keep), cbackground, cbackgroundLength, C.gint(pageHeight), cprofile); err != 0 {
		return handleVipsError()
	}
	return nil
}
...
func vipsgenWebpsaveBufferWithOptions(in *C.VipsImage, q int, lossless bool, exact bool, preset WebpPreset, smartSubsample bool, nearLossless bool, alphaQ int, minSize bool, kmin int, kmax int, effort int, targetSize int, mixed bool, smartDeblock bool, passes int, keep Keep, background []float64, pageHeight int, profile string) ([]byte, error) {
	var buf unsafe.Pointer
	var length C.size_t
	cbackground, cbackgroundLength, err := convertToDoubleArray(background)
	if err != nil {
	...
	cprofile := C.CString(profile)
	defer freeCString(cprofile)
	if err := C.vipsgen_webpsave_buffer_with_options(in, &buf, &length, C.gint(q), C.int(boolToInt(lossless)), C.int(boolToInt(exact)), C.VipsForeignWebpPreset(preset), C.int(boolToInt(smartSubsample)), C.int(boolToInt(nearLossless)), C.gint(alphaQ), C.int(boolToInt(minSize)), C.gint(kmin), C.gint(kmax), C.gint(effort), C.gint(targetSize), C.int(boolToInt(mixed)), C.int(boolToInt(smartDeblock)), C.gint(passes), C.VipsForeignKeep(keep), cbackground, cbackgroundLength, C.gint(pageHeight), cprofile); err != 0 {
		return nil, handleVipsError()
	}
	return bufferToBytes(buf, length), nil
}
...
func vipsgenWebpsaveTargetWithOptions(in *C.VipsImage, target *C.VipsTargetCustom, q int, lossless bool, exact bool, preset WebpPreset, smartSubsample bool, nearLossless bool, alphaQ int, minSize bool, kmin int, kmax int, effort int, targetSize int, mixed bool, smartDeblock bool, passes int, keep Keep, background []float64, pageHeight int, profile string) (error) {
	cbackground, cbackgroundLength, err := convertToDoubleArray(background)
	if err != nil {
		return err
	}
	...
	cprofile := C.CString(profile)
	defer freeCString(cprofile)
	if err := C.vipsgen_webpsave_target_with_options(in, target, C.gint(q), C.int(boolToInt(lossless)), C.int(boolToInt(exact)), C.VipsForeignWebpPreset(preset), C.int(boolToInt(smartSubsample)), C.int(boolToInt(nearLossless)), C.gint(alphaQ), C.int(boolToInt(minSize)), C.gint(kmin), C.gint(kmax), C.gint(effort), C.gint(targetSize), C.int(boolToInt(mixed)), C.int(boolToInt(smartDeblock)), C.gint(passes), C.VipsForeignKeep(keep), cbackground, cbackgroundLength, C.gint(pageHeight), cprofile); err != 0 {
		return handleVipsError()
	}
	return nil
}
