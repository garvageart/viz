<script lang="ts">
    ...
    "400": "<path d=\"M200-440v-80h560v80z\" />"
};
    const filledVariants: Record<string, string> = {
    "400": "<path d=\"M200-450v-60h560v60z\" />"
};
    let { size = "1.5em", className = "", title = "remove", viewBox = "0 -960 960 960", weight = "400", fill = false, ...rest } = $props();
