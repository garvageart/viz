    ...
    containsNode(targetId: string): boolean {
        ...
        return this.children.some((child) => {
            if (child instanceof TabGroup) {
                return child.containsNode(targetId);
            }
...
export class Workspace {
     ...
     */
    findNode(id: string, startNode: SplitNode | TabGroup = this.root): SplitNode | TabGroup | null {
        if (startNode.id === id) {
            return startNode;
        }
     ...
     */
    findGroupWithPath(path: string, startNode: SplitNode | TabGroup = this.root): TabGroup | null {
        if (startNode instanceof TabGroup) {
     ...
     */
    findViewWithPath(path: string, startNode: SplitNode | TabGroup = this.root): VizView | null {
        if (startNode instanceof TabGroup) {
