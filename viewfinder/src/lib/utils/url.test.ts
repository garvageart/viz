...
describe('url utils', () => {
    ...
    describe('getGitBranchUrl', () => {
        ...
        it('formats GitHub branch URLs correctly', () => {
            expect(getGitBranchUrl('git@github.com:user/repo.git', 'main')).toBe('https://github.com/user/repo/tree/main');
        });

        it('formats GitLab branch URLs correctly', () => {
            expect(getGitBranchUrl('https://gitlab.com/user/repo.git', 'feat/branch')).toBe('https://gitlab.com/user/repo/-/tree/feat/branch');
        });
    ...
    describe('getGitCommitUrl', () => {
        ...
        it('formats GitHub commit URLs correctly', () => {
            expect(getGitCommitUrl('git@github.com:user/repo.git', 'vikstarr123')).toBe('https://github.com/user/repo/commit/vikstarr123');
        });

        it('formats GitLab commit URLs correctly', () => {
            expect(getGitCommitUrl('https://gitlab.com/user/repo.git', 'vikstarr123')).toBe('https://gitlab.com/user/repo/-/commit/vikstarr123');
        });
