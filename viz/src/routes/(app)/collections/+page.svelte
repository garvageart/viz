...
<script lang="ts">
    ...
    let shouldUpdate = $derived(
        listOfCollectionsData?.length > pagination.limit * pagination.offset,
    );
    ...
    <div id="viz-collection-modal">
        ...
        <form
            ...
            onsubmit={async (event) => {
                ...
                const toggleSwitch = event.currentTarget.querySelector(
                    "#create_collection-private",
                ...
                const response = await createCollection({
                    ...
                    private:
                        toggleSwitch.getAttribute("data-checked") === "true",
                });
        ...
        >
            ...
            <textarea
                id="create_collection-description"
                name="description"
                rows="1"
                placeholder="Description (optional)"
            />
            <SliderToggle
                id="create_collection-private"
