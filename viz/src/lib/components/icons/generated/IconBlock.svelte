<script lang="ts">
    ...
    "400": "<path d=\"M480-80q-83 0-156-31.5T197-197t-85.5-127T80-480t31.5-156T197-763t127-85.5T480-880t156 31.5T763-763t85.5 127T880-480t-31.5 156T763-197t-127 85.5T480-80m219-140q11-9 21.5-18.86Q731-248.73 740-260L260-740q-11.27 9-21.14 19.5Q229-710 220-699z\" />"
};
    let { size = "1.5em", className = "", title = "IconBlock", viewBox = "0 0 24 24", weight = "400", fill = false, ...rest } = $props();
