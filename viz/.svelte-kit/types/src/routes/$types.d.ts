...
type LayoutParams = RouteParams & {  ***REMOVED***
type LayoutParentData = EnsureDefined<{***REMOVED***>;
...
export type LayoutProps = { data: LayoutData; children: import("svelte"***REMOVED***.Snippet ***REMOVED***